...
import cn.elevator.ui.mvp.home.check.chekinfo.CheckInfoPresenter;
...
public class VerifyInfoActivity extends AppCompatActivity implements VerifyInfoContact.View, View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        LinearLayout view = (LinearLayout) LayoutInflater.from(this).inflate(R.layout.activity_verify_info, null);
        setContentView(view);
        initViews(view);
        initTaskData();
        initCheckPersonData();
...
//        presenter.getCheckPersonList(verifys);
    ...
    public void initViews(View view) {
        presenter = new VerifyInfoPresenter(this);
